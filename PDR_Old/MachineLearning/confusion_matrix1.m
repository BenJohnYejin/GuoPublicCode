...
title(''); 
textStrings = num2str(mat(:),'%0.00f');       %# Create strings from the matrix values
...
set(gca,'XTick',1:4,...                                    
        'XTickLabel',{'发信息','打电话','摆臂','口袋'},...  %#   and tick labels
        'YTick',1:4,...                                    %同上
        'YTickLabel',{'发信息','打电话','摆臂','口袋'},...
        'TickLength',[0 0]);
